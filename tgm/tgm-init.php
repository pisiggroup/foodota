...
function foodota_register_required_plugins()
{
    $plugins = array(
        array(
            ...
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/redux-framework.4.4.10.zip'
            ),
            'is_callable' => '',
        ),
        array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/wc-multivendor-membership.2.10.6.zip'),
            'is_callable' => '',
        ),
        array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/woocommerce.8.3.1.zip'),
            'is_callable' => '',
        ),
        array(
        ...
        array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/wc-multivendor-marketplace.3.6.3.zip'),
            'is_callable' => '',
        ),
        array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/wc-frontend-manager.6.7.4.zip'),
            'is_callable' => '',
        ),
        array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/elementor.3.18.2.zip'),
            'is_callable' => '',
        ),
        array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/post-views-counter.1.4.3.zip'),
            'is_callable' => '',
        ),
        array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/one-click-demo-import.3.2.0.zip'),
            'is_callable' => '',
        ),
    );
