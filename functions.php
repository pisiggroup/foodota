...
function foodota_scripts()
{
    ...
    $maper_key = '';
    if (isset($foodota_options['map-api-key']) && $foodota_options['map-api-key'] != '') {
    ...
    wp_enqueue_script("select2-custom", trailingslashit(get_template_directory_uri()) . "libs/js/select2.min.js", false, false, true);
