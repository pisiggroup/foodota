    ...
    <div class="row">
        ...
        <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-5 col-sm-6 ">
            <div class="res-f-content2 section-padding px-0 col-lg-10">
                <div class="heading-panel2">
                    <h3><?php echo wp_kses($news_title,$allowed_html); ?></h3>
                    <p><?php echo wp_kses($news_text,$allowed_html); ?></p>
                </div>
                <form>
                    <div class="form-group">
                        <input type="text" placeholder="<?php echo esc_attr($news_input); ?>"
                               class="form-control">
                        <a href="<?php echo esc_url($dynamic_url); ?>" class="btn btn-theme"><?php echo esc_html($news_button); ?></a></div>
                </form>
                <div class="res-f-social">
                    <div class="heading-panel2">
                        <h3><?php echo wp_kses($social_text,$allowed_html); ?></h3>
                    </div>
                    <?php
